  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full bg-[#181a24] hover:bg-[#222533] border border-[#2d3247] text-white py-3 px-4 rounded font-label-sm text-sm font-semibold flex items-center justify-center gap-3 transition-all mb-6 shadow-md"
      >
